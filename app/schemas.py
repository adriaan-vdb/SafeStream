...
class ChatMessageOut(BaseModel):
    ...
    Matches README API protocol: {"type":"chat","user":"alice","message":"hello","toxic":false,"score":0.02,"ts":"2025-06-26T12:34:56Z","blocked":false}
    """
    ...
    blocked: bool = Field(
        default=False,
        description="Whether message was blocked due to toxicity threshold",
    )
